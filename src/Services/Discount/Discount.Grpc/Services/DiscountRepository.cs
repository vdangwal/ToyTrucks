...
namespace ToyTrucks.Discount.Grpc.Services
{
    public class DiscountRepository : IDiscountRepository
    {
        ...
        private const string UPDATE_DISCOUNT_SQL = "UPDATE Coupon SET  Description = @Description, Amount = @Amount WHERE ProductName=@ProductName";
        ...
        public async Task<bool> DiscountExists(string productName)
        {
        ...
        public async Task<Coupon> GetDiscountById(int recordId)
        {
            using var connection = new NpgsqlConnection(_connectionString);
