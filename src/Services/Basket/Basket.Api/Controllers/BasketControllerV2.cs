...
namespace Basket.Api.Controllers
{
    ...
    public class BasketControllerV2 : ControllerBase
    {
        ...
        public BasketControllerV2(IBasketService service, IMapper mapper, DiscountGrpcService discountService, IPublishEndpoint publishEndpoint, ILogger<BasketController> logger)
        {
